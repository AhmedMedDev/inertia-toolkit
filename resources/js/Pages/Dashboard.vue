        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200 d-flex" v-for="post in posts.data">
                        <div class="">
                            Title : {{ post.title }} <br>
                            Body : {{ post.body }}
                        </div>
                        <div class="">
                            <Link class="mr-2 px-6 py-2 text-white bg-gray-900 rounded "
                                :href="route('posts.show', post.id)">
                            Edit
                            </Link>
                            <Link class="px-6 py-2 text-white bg-gray-900 rounded " as="button" type="button"
